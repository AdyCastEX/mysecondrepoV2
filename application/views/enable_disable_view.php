...
?>
		...
		<script type = "text/javascript" src = "http://localhost/mysecondrepoV2/js/search_user_manager.js"></script>
		<script type = "text/javascript" src = "http://localhost/mysecondrepoV2/js/account_status_manager.js"></script>
